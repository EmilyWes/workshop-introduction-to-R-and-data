...
```{=html}
<iframe src="https://cran.r-project.org/web/packages/available_packages_by_name.html" width="100%" height="500"></iframe>
```
...
![](images/csv-file.png){width=60%}
![](images/tsv-file.png){width=60%}
...
Basic use:
```r
select(your-dataframe, week1, week2)  # select the week1 & week2 columns
```
...
```r
select(your-dataframe, -week3)       # select all columns, except week3
```
. . .

Use special [selecting functions](https://tidyselect.r-lib.org/reference/language.html)
```r
select(your-dataframe, contains("week"))    # select columns containing "week"
``` 
...
# Reshaping Data {background-color=#FFCD00}

## Long vs. Wide Data

![source: <https://tavareshugo.github.io/r-intro-tidyverse-gapminder/>](images/pivot-no-code.png)
...
- Efficient for simple comparisons across categories  
- Easier to read at a glance  

**CONS**

- Becomes unwieldy with many variables or time points  
- Not suitable for many statistical or machine-learning models  
:::
...
- Works well with `tidyverse`-aligned packages  
- Flexible manipulation with easy grouping & summarization  
...
![source: <https://tavareshugo.github.io/r-intro-tidyverse-gapminder/>](images/pivot-with-code.png)
...
## Our df from the morning - but extended
...
## Our df from the morning - but extended + pivoted
...
![source: <https://statisticsglobe.com/r-dplyr-join-inner-left-right-full-semi-anti>](images/dplyr-joins.png)
Read more about joins in [R for Data Science](https://r4ds.hadley.nz/joins#how-do-joins-work). Today, we'll focus on `full_join()`.
